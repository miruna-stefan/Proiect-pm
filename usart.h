...
/*
 * Trasmits a null-terminated string through the USART, newline-terminated.
 *
 * @param str: the string to send
 */
void USART0_println(const char *str);

/*
 * Trasmits an integer through the USART.
 *
 * @param n: the integer to send
 */
void USART0_print_int(int n);
